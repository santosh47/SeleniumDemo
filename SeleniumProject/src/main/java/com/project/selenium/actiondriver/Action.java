 ...
 * 
 */
package com.project.selenium.actiondriver;
...
public class Action extends BaseClass {
	...
	static Duration duration=Duration.ofSeconds(timeout);
	...
	public boolean switchToFrameByIndex(WebDriver driver,int index) {
		boolean flag = false;
		try {
			new WebDriverWait(driver, duration).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//iframe")));
